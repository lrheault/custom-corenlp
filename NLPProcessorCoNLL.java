...
A simple Java wrapper for Stanford CoreNLP producing a CoNLL output with line and sentence numbering.
...
Example usage:
java -cp "*:." -Xmx16g NLPProcessorCoNLL [batch-file] [input-dir] [output-dir]
